...
\par The next test $t1$ reuses Rastrigin 1D function in the interval of $[\pi:2\pi]$ and figure 37 shows the plot of the points in x-axis and uses y-space for function evaluations.
